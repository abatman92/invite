  ...
  return (
    <>
      ...
      >
          ...
          return (
            <div key={index} className="container">
              <div className="inp-container">
                ...
                />
                <ErrorMessage errors={errors} name={`person.${index}.name`} render={({ message }) => <p>{message}</p>}/>
              </div>
              <div className="inp-container">
                ...
                />
                <ErrorMessage errors={errors} name={`person.${index}.email`} render={({ message }) => <p>{message}</p>}/>
              </div>
              {index > 0 && (
        ...
        />
        <ErrorMessage errors={errors} name="timestamp" render={({ message }) => <p>{message}</p>}/>
